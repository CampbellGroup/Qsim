...
class QCustomWavemeterChannel(QtGui.QFrame):
    def __init__(self, title, frequency, parent=None):
        QtGui.QWidget.__init__(self, parent)
        self.setFrameStyle(0x0001 | 0x0030)
        self.makeLayout(title, frequency)
    
    def makeLayout(self, title, frequency):
...
if __name__=="__main__":
    ...
    icon = QCustomWavemeterChannel('369','405.645745')
    icon.show()
    app.exec_()