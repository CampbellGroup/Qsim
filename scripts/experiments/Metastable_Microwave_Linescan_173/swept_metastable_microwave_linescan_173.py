...
class MetastableMicrowaveLineScanSwept173(QsimExperiment):
    ...
    def run(self, cxn, context):
        ...
        self.detunings = self.get_scan_list(self.p.SweptMetastableMicrowaveLinescan173.scan, 'kHz')
        self.p['Metastable_Microwave_Interrogation.ramp_width'] = U(self.detunings[1] - self.detunings[0], 'MHz')
