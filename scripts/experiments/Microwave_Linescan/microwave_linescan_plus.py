import labrad
from Qsim.scripts.pulse_sequences.microwave_point.microwave_point_plus import (
    MicrowavePointPlus as sequence,
)
...
class MicrowaveLineScanPlus(QsimExperiment):
    ...
    def run(self, cxn, context):
        ...
        print("Updated qubit_plus frequency to " + str(popt[1]) + " kHz")
...
if __name__ == "__main__":
    ...
    exprt = MicrowaveLineScanPlus(cxn=cxn)
