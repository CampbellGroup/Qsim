...
from Qsim.scripts.experiments.Microwave_Linescan.microwave_linescan_minus import (
    MicrowaveLineScanMinus,
)
from Qsim.scripts.experiments.Microwave_Linescan.microwave_linescan_plus import (
    MicrowaveLineScanPlus,
)
...
class HighFidelityDarkStateSpam(QsimExperiment):
    ...
    def run(self, cxn, context):
        ...
        while True:
            ...
            countsDark, countsDopFixed = self.delete_doppler_count_errors(
                counts_doppler_dark, counts_dark
            )
            ...
            if i == 1:
                ...
                print(
                    "mean doppler counts on first experiment is  = "
    ...
    def perform_initial_tweak_up(self):
        ...
        self.init_dac_port_hudson_voltage = self.mp_server.get_output_voltage(
            self.dac_port_hudson
        )
    ...
    def setup_high_fidelity_datavault(self):
        ...
        self.dv.cd(
            ["shelving_fidelity_dark_only", "shelving_probability_vs_runs"],
            True,
        ...
        self.dv.cd(
            ["shelving_fidelity_dark_only", "shelving_counts_dark_only"],
            True,
        ...
        self.dv.cd(
            ["shelving_fidelity_dark_only", "shelving_rabi_tracking"],
            True,
