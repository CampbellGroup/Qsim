    ...
    def run(self, cxn, context):
        ...
        while True:
            ...
            if self.currentfreq and counts:
                tempdata.append([self.currentfreq["GHz"], cozzunts])

    def currentfrequency(self):
        self.currentfreq = WithUnit(
            float("%.6f" % self.wm.get_frequency(self.laserport)) - 751.527140, "THz"
        )
