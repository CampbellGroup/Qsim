import labrad
import numpy as np
from Qsim.scripts.pulse_sequences.ML_interrogation_point import (
    ML_interrogation_point as ml_interrogation_point,
)
...
class Pulsed_delay_stage_scan(QsimExperiment):
    ...
    def set_scannable_parameters(self):
        ...
        self.cooling_center = self.p.Transitions.main_cooling_369 / 2.0 + U(
            200.0, "MHz"
        )
