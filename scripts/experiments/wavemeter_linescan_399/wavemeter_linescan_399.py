...
class wavemeter_linescan_399(experiment):
    ...
    name = 'Wavemeter Line Scan 399'
    
    required_parameters = [('scan399', 'frequency')]
    
    def initialize(self, cxn, context, ident):
        self.ident = ident
        self.laserport = 8
        self.cxn = labrad.connect(name = '399 Wavemeter Line Scan')
        self.cxnwlm = labrad.connect('10.97.112.2', name = '399 Scan')
    ...
    def run(self, cxn, context):
        ...
        frequency = self.pv.get_parameter('scan399','frequency')                
