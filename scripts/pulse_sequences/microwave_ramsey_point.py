...
class microwave_ramsey_point(pulse_sequence):
    ...
    required_subsequences = [turn_off_all, doppler_cooling, microwave_interogation,shelving_state_detection, ml_state_detection, standard_state_detection, optical_pumping, empty_sequence]
