...
from scripts.pulse_sequences.sub_sequences._deprecated.ZeemanOpticalPumping import zeeman_bright_optical_pumping
from scripts.pulse_sequences.sub_sequences._deprecated.ZeemanOpticalPumping import zeeman_dark_optical_pumping
