...
class KnillPulseAreaCorrectingSequence(PulseSequence):
    """
    ...
    def sequence(self):
        ...
        self.add_ttl(
            "MicrowaveTTL",
            self.start
            + 2 * p.MicrowaveInterrogation.duration
            + 3 * ttl_off
            + start_delay,
            p.MicrowaveInterrogation.duration - ttl_delay,
        )
        ...
        self.add_ttl(
            "MicrowaveTTL",
            self.start
            + +3 * p.MicrowaveInterrogation.duration
            + 4 * ttl_off
            + start_delay,
            p.MicrowaveInterrogation.duration - ttl_delay,
        )
        ...
        self.add_ttl(
            "MicrowaveTTL",
            self.start
            + +4 * p.MicrowaveInterrogation.duration
            + 5 * ttl_off
            + start_delay,
            p.MicrowaveInterrogation.duration - ttl_delay,
        )
