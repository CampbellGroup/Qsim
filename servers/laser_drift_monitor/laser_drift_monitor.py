...
class laser_drift_monitor(LabradServer):
    ...
    def initServer(self):
        ...
        self.set_freq171 = [
            ...
            812.109250,
            752.452635,
        ]  # desired frequencies of lasers for Yb171
        self.set_freq174 = [
            320.571657,
            469.439000,
            812.111480,
            752.451800,
        ]  # desired frequencies of lasers for Yb174
    ...
    def loops(self):
        ...
        drift0, drift1, drift2 = (
            1000000 * (self.set_freq[0] - freq0),
            1000000 * (self.set_freq[1] - freq1),
            1000000 * (self.set_freq[2] - freq2),
        )
    ...
    def setup_datavault(self, x_axis, y_axis):
        ...
        self.dataset935 = yield self.dv.new(
            self.name + " 935",
            [("t", "num")],
            [("MHz", "", "num")],
            context=self.ctx935,
        )
        self.dataset638 = yield self.dv.new(
            self.name + " 638",
            [("t", "num")],
            [("MHz", "", "num")],
            context=self.ctx638,
        )
        self.dataset369 = yield self.dv.new(
            self.name + " 369",
            [("t", "num")],
            [("MHz", "", "num")],
            context=self.ctx369,
        )
        self.dataset399 = yield self.dv.new(
            self.name + " 399",
            [("t", "num")],
            [("MHz", "", "num")],
            context=self.ctx399,
